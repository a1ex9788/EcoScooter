...
namespace EcoScooter.Services
{
    public interface IEcoScooterService
    {
        ...
        /// <returns></returns>
        ///  <exception cref="ServiceException">Thrown when user's data is incorrrect</exception>
        bool isLoggedAsUserByLogin(string name);

        /// <summary>
        /// Returns true if the Employe is the current logged Employe, false otherwise
        /// </summary>
        /// <param name="name"></param>
        /// <returns></returns>
        ///  <exception cref="ServiceException">Thrown when user's data is incorrrect</exception>
        bool isLoggedAsEmployeeByLogin(string name);
        ...
        /// <summary>
        /// Void, user or employee disconect. 
        /// </summary>         
        void ExitUser();
        ...
        /// </summary>        
        ICollection<Station> getStationList();
        ...
        void RegisterEmployee(DateTime birthDate, String dni, String email, String name, int telephon, String iban, int pin, String position, Decimal salary);
